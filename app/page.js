...
`}</style>
      ...
      <div className="fixed inset-0 z-0">
        <img src="/bd2.jpeg" alt="Background Studio" className="w-full h-full object-cover" />
            ...
            return (
              <motion.div
                ...
                animate={{
                  ...
                  filter: isCenter ? "brightness(1)" : "brightness(0.3)", // Gelapkan lagi tepi supaya fokus tengah
                }}
                transition={{
                  type: "spring",
                  stiffness: 300,
