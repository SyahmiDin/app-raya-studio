...
function BookingContent() {
  ...
  const visibleServices =
    isPackageLocked && selectedService ? [selectedService] : services;
      ...
      <div className="py-6 px-4 sm:px-6 lg:px-8 flex-grow">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-[0_10px_40px_-15px_rgba(0,0,0,0.1)] border border-[#e5e0d8] flex flex-col items-center justify-center text-center relative overflow-hidden">
            ...
            <h3 className="text-xl font-bold text-gray-700 uppercase tracking-widest mb-4">
              Pilih Tarikh Sesi
            </h3>
            ...
            <p className="mt-3 text-xs text-gray-400 font-medium">
              Sila pastikan tarikh adalah betul
            </p>
          </div>
          ...
          <div className="relative">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-10 h-10 rounded-full bg-[#412986] text-[#D4AF37] flex items-center justify-center font-bold text-lg shadow-lg shadow-purple-900/20">
                1
              </div>
            ...
            <div
              className={`gap-6 ${isPackageLocked ? "flex justify-center" : "grid grid-cols-1 md:grid-cols-3"}`}
            >
              {visibleServices.map((service) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`absolute top-0 left-0 right-0 h-2 ${isSelected ? "bg-[#D4AF37]" : "bg-[#412986]"}`}
                    ></div>
            ...
            {isPackageLocked && (
              <div className="mt-6 text-center">
                <a
                  href="/"
                  className="inline-block text-xs font-bold text-[#412986] hover:text-[#D4AF37] border-b border-transparent hover:border-[#D4AF37] transition"
                >
                  ← Pilih Pakej Lain
                </a>
              </div>
          ...
          <div className="relative pt-6">
            ...
            {selectedService && (
              <div
                id="calendar-section"
                className="animate-fade-in-up bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-[#e5e0d8]"
              >
                {!selectedDate ? (
                  ...
                  <div className="space-y-8">
                    {(() => {
                      ...
                      const sessions = [
                        {
                          label: "Sesi Pagi [10.00 AM - 1.00 PM]",
                          slots: filterSlots(10, 13),
                        },
                        {
                          label: "Sesi Petang [2.00 PM - 6.00 PM]",
                          slots: filterSlots(14, 18),
                        },
                        {
                          label: "Sesi Malam [8.00 PM - 11.00 PM]",
                          slots: filterSlots(20, 24),
                        },
                      ];

                      if (allSlots.length === 0) {
                        return (
                          <p className="text-center text-red-400 font-medium py-8 bg-red-50 rounded-xl">
                            Maaf, semua slot telah penuh pada tarikh ini.
                          </p>
                        );
                      }
                                ...
                                {session.slots.map((slot, idx) => {
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      {isSelected && (
                                        <span className="text-[10px] text-[#D4AF37] mt-1">
                                          Dipilih
                                        </span>
                                      )}
                                      {isPending && (
                                        <span className="text-[9px] text-orange-500 font-bold mt-1 uppercase">
                                          Pending
                                        </span>
                                      )}
              ...
              <div className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100">
                ...
                <div className="bg-slate-50 p-6 rounded-xl border border-slate-100 space-y-5">
                  <div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      <input
                        ...
                        onChange={(e) => {
                          setFormData({
                            ...formData,
                            referral: e.target.value.toUpperCase(),
                          });
                          setPromoStatus(null);
                          setPromoMessage("");
                        }}
                    ...
                    {promoMessage && (
                      <p
                        className={`text-xs font-bold mt-2 ${promoStatus === "valid" ? "text-green-600" : "text-red-500"}`}
                      >
                        {promoMessage}
                      </p>
                    )}
                  ...
                  {/* --- INPUT PAX (DYNAMIC LIMIT) --- */}
                  <div>
                    {/* Logic Kira Limit Berdasarkan Nama Pakej */}
                    {(() => {
                      let maxPax = 15; // Default limit
                      if (selectedService) {
                        const n = selectedService.name.toUpperCase();
                        if (n.includes("SMALL")) maxPax = 5;
                        else if (n.includes("MEDIUM")) maxPax = 10;
                        else if (n.includes("LARGE")) maxPax = 15;
                      }
                      ...
                      return (
                        <>
                          <label className="block text-xs font-bold text-gray-500 mb-2">
                            Bilangan Pax{" "}
                            {selectedService ? `(Maks: ${maxPax})` : ""}
                          </label>
                          <div className="relative">
                            <select
                              className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#412986] outline-none text-gray-700 bg-white font-bold text-center appearance-none cursor-pointer disabled:bg-gray-100 disabled:text-gray-400"
                              onChange={(e) =>
                                setFormData({
                                  ...formData,
                                  pax: e.target.value,
                              ...
                              value={formData.pax}
                              disabled={!selectedService} // Disable kalau belum pilih pakej
                            >
                              <option value="" disabled>
                                -- Pilih Jumlah --
                              </option>

                              {/* Generate nombor dari 1 hingga maxPax */}
                              {Array.from(
                                { length: maxPax },
                                (_, i) => i + 1,
                              ).map((num) => (
                ...
                <div className="mt-6 bg-[#faf5ff] p-6 rounded-xl border border-purple-100">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span className="font-bold text-sm text-gray-900 text-right">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-extrabold text-2xl text-[#412986]">
                ...
                <div className="mt-6 mb-2 p-4 bg-yellow-50 border border-yellow-100 rounded-xl flex items-start gap-3">
                  ...
                  >
                    ...
                    <button
                      ...
                      className="font-bold text-[#412986] hover:underline underline-offset-2"
                    >
                      Terma & Syarat
                    </button>{" "}
                    dari Studio ABG Raya, dengan ini mengesahkan pilihan dan
                    butiran tempahan saya.
                  </label>
                </div>
          ...
          <div className="flex justify-center mb-6">
            ...
            >
              ...
              <p className="text-sm md:text-base leading-relaxed max-w-xs md:max-w-none">
                ...
                <br className="md:hidden" /> 71760 Nilai, Negeri Sembilan
              </p>
            </a>
          </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[80vh] flex flex-col animate-scale-up overflow-hidden">
            ...
            <div className="p-6 overflow-y-auto text-sm text-gray-700 space-y-6 leading-relaxed">
              {/* Seksyen 1 */}
              <div>
                <h4 className="font-bold text-[#412986] mb-2 border-b pb-1">
                  1. Polisi Pembayaran
                </h4>
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    <strong>Tiada Deposit:</strong> Kami tidak mengambil
                    sebarang deposit. Walau bagaimanapun, bayaran penuh (Full
                    Payment) mengikut pakej mestilah dijelaskan semasa tempahan
                    dibuat.
                  </li>
                  <li>
                    <strong>Pengesahan Slot:</strong> Slot anda akan dihantar ke
                    emel yang anda isi semasa membuat tempahan.
                  </li>
                </ul>
              </div>
              ...
              <div>
                <h4 className="font-bold text-[#412986] mb-2 border-b pb-1">
                  2. Pembatalan & Pemulangan Wang (Refund)
                </h4>
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    <strong>Pembatalan oleh Pelanggan:</strong> Jika anda
                    membatalkan tempahan, hanya 50% sahaja daripada bayaran
                    penuh akan dipulangkan semula.
                  </li>
                  <li>
                    <strong>No-Show:</strong> Sekiranya pelanggan tidak hadir
                    pada hari kejadian tanpa sebarang notis, bayaran penuh tidak
                    akan dipulangkan (non-refundable).
                  </li>
                  <li>
                    <strong>Pembatalan oleh Studio:</strong> Jika pihak studio
                    terpaksa membatalkan sesi atas sebab kecemasan, bayaran akan
                    dipulangkan 100% atau dijadualkan semula mengikut
                    persetujuan.
                  </li>
                </ul>
              </div>
              ...
              <div>
                <h4 className="font-bold text-[#412986] mb-2 border-b pb-1">
                  3. Penjadualan Semula (Reschedule)
                </h4>
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    Penjadualan semula dibenarkan sekali sahaja dan mestilah
                    dimaklumkan sekurang-kurangnya 48 jam sebelum waktu sesi.
                  </li>
                  <li>
                    Permintaan reschedule pada saat akhir (kurang 24 jam) tidak
                    akan dilayan dan bayaran dianggap hangus jika pelanggan
                    tidak hadir.
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    Sesi penggambaran adalah mengikut waktu tepat yang telah
                    ditempah.
                  </li>
                  <li>
                    Jika pelanggan lewat, masa sesi tidak akan ditambah. Sebagai
                    contoh, jika anda lewat 5 minit, sesi anda hanya berbaki 20
                    minit (untuk slot 25 minit).
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    Sila patuhi had maksimum [Jumlah] orang bagi setiap sesi.
                  </li>
                  <li>
                    Pelanggan bertanggungjawab sepenuhnya ke atas keselamatan
                    diri dan barang peribadi sepanjang berada di studio.
                  </li>
                </ul>
              </div>
              ...
              <h3 className="font-black text-center text-gray-900 uppercase">
                Polisi Privasi Pelanggan (Privacy Policy)
              </h3>

              {/* Privasi 1 */}
              <div>
                <h4 className="font-bold text-[#412986] mb-2">
                  1. Maklumat Yang Dikumpul
                </h4>
                <p>
                  Kami hanya mengumpul maklumat yang diperlukan untuk urusan
                  tempahan dan sesi fotografi, termasuk:
                </p>
              ...
              <div>
                <h4 className="font-bold text-[#412986] mb-2">
                  2. Penggunaan Gambar (Copyright & Social Media)
                </h4>
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    <strong>Hak Milik:</strong> Semua gambar yang diambil adalah
                    milik pelanggan bagi kegunaan peribadi. Walau bagaimanapun,
                    hak cipta (copyright) karya seni tersebut kekal di bawah Al
                    Bayan Studio
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    gambar keluarga anda dipaparkan secara awam, sila maklumkan
                    kepada kami semasa hari sesi.
                  </li>
                </ul>
              </div>
              ...
              <div>
                <h4 className="font-bold text-[#412986] mb-2">
                  3. Keselamatan Fail & Gambar
                </h4>
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    Semua gambar anda disimpan dalam storan digital yang selamat
                    (Cloud/Hard Drive) dan hanya boleh diakses oleh pihak
                    studio.
                  </li>
                  <li>
                    Link muat turun yang diberikan kepada anda adalah tertutup.
                    Kami menasihatkan anda untuk tidak berkongsi link tersebut
                    kepada pihak ketiga yang tidak dikenali.
                  </li>
                  <li>
                    Fail anda akan dipadam secara kekal daripada storan kami
                    selepas tempoh 6 bulan dari tarikh penyerahan gambar.
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p>
                  Kami tidak akan menjual atau berkongsi maklumat peribadi anda
                  (nombor telefon/emel) kepada mana-mana pihak ketiga atau
                  syarikat pemasaran.
                </p>
              </div>

              <div className="bg-gray-100 p-4 rounded-lg text-xs text-gray-500 italic text-center">
                Nota Penafian: Dengan melanggan servis kami, anda bersetuju
                dengan pengurusan data dan gambar mengikut terma di atas demi
                menjaga privasi kedua-dua belah pihak.
              </div>
            </div>
...
export default function BookingPage() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen flex items-center justify-center text-[#412986] animate-pulse">
          Memuatkan Sistem Tempahan...
        </div>
      }
    >
      <BookingContent />
